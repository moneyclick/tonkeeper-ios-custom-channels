...
public enum TKLocales {
    ...
    public enum Actions {
        ...
        /// Retry
        public static let retry = TKLocales.tr("Localizable", "actions.retry", fallback: "Retry")
        /// Save
        ...
        public enum StakingItem {
            ...
            public enum Comment {
                ...
                public static func ready(_ p1: Any) -> String {
                    return TKLocales.tr("Localizable", "balance_list.staking_item.comment.ready", String(describing: p1), fallback: "%@ GRAM ready.\nTap to collect.")
                }

                /// %@ GRAM staked
                public static func staked(_ p1: Any) -> String {
                    return TKLocales.tr("Localizable", "balance_list.staking_item.comment.staked", String(describing: p1), fallback: "%@ GRAM staked")
                }
    ...
    public enum Chart {
        /// Last day
        public static let lastDay = TKLocales.tr("Localizable", "chart.last_day", fallback: "Last day")
        /// Last 6 months
        public static let lastHalfYear = TKLocales.tr("Localizable", "chart.last_half_year", fallback: "Last 6 months")
        /// Last hour
        public static let lastHour = TKLocales.tr("Localizable", "chart.last_hour", fallback: "Last hour")
        /// Last month
        public static let lastMonth = TKLocales.tr("Localizable", "chart.last_month", fallback: "Last month")
        /// Last week
        public static let lastWeek = TKLocales.tr("Localizable", "chart.last_week", fallback: "Last week")
        /// Last year
    ...
    public enum Ethena {
        ...
        /// Boost APY in GRAM
        public static let boostApyInTon = TKLocales.tr("Localizable", "ethena.boost_apy_in_ton", fallback: "Boost APY in GRAM")
        /// Check Eligibility
    ...
    public enum InsufficientFunds {
        ...
        /// Required for blockchain fees: %@ GRAM.
        /// Your balance: %@ GRAM.
        public static func feeRequired(_ p1: Any, _ p2: Any) -> String {
            return TKLocales.tr("Localizable", "insufficientFunds.fee_required", String(describing: p1), String(describing: p2), fallback: "Required for blockchain fees: %@ GRAM.\nYour balance: %@ GRAM.")
        }
    ...
    public enum MultichainHistory {
        public enum Placeholder {
            ...
            /// Your activity
            /// will be shown here
            public static let title = TKLocales.tr("Localizable", "multichain_history.placeholder.title", fallback: "Your activity\nwill be shown here")
            public enum Buttons {
                /// Add Funds
    ...
    public enum Ramp {
        public enum Deposit {
            /// %@ address
            public static func addressLabel(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.deposit.address_label", String(describing: p1), fallback: "%@ address")
            }

            /// This address can be used only once. Check purchase limits and network to avoid losing your funds.
            public static let addressWarning = TKLocales.tr("Localizable", "ramp.deposit.address_warning", fallback: "This address can be used only once. Check purchase limits and network to avoid losing your funds.")
            ...
            /// This address can be used only once. Check purchase limits, network, and memo to avoid losing your funds.
            public static let addressWarningWithMemo = TKLocales.tr("Localizable", "ramp.deposit.address_warning_with_memo", fallback: "This address can be used only once. Check purchase limits, network, and memo to avoid losing your funds.")
            ...
            /// Copy Details
            public static let copyDetails = TKLocales.tr("Localizable", "ramp.deposit.copy_details", fallback: "Copy Details")
            /// Buy with Cash or Crypto
            public static let depositWithCashOrCrypto = TKLocales.tr("Localizable", "ramp.deposit.deposit_with_cash_or_crypto", fallback: "Buy with Cash or Crypto")
            /// Destination tag (Memo)
            public static let destinationTagMemo = TKLocales.tr("Localizable", "ramp.deposit.destination_tag_memo", fallback: "Destination tag (Memo)")
            /// Est. arrival time
            public static let estArrivalTime = TKLocales.tr("Localizable", "ramp.deposit.est_arrival_time", fallback: "Est. arrival time")
            /// Choose option to deposit crypto
            public static let fiatCurrencyBlockHeading = TKLocales.tr("Localizable", "ramp.deposit.fiat_currency_block_heading", fallback: "Choose option to deposit crypto")
            /// Methods of purchase for
            public static let fiatCurrencyRowCaption = TKLocales.tr("Localizable", "ramp.deposit.fiat_currency_row_caption", fallback: "Methods of purchase for")
            /// Go to Main
            public static let goToMain = TKLocales.tr("Localizable", "ramp.deposit.go_to_main", fallback: "Go to Main")
            /// Max amount
            public static let maxAmount = TKLocales.tr("Localizable", "ramp.deposit.max_amount", fallback: "Max amount")
            /// Required
            public static let memoRequiredBadge = TKLocales.tr("Localizable", "ramp.deposit.memo_required_badge", fallback: "Required")
            /// Min amount
            public static let minAmount = TKLocales.tr("Localizable", "ramp.deposit.min_amount", fallback: "Min amount")
            /// Network
            ...
            /// Add Funds
            public static let title = TKLocales.tr("Localizable", "ramp.deposit.title", fallback: "Add Funds")
            /// Up to %@ min
            public static func upToMin(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.deposit.up_to_min", String(describing: p1), fallback: "Up to %@ min")
            }
            ...
            public enum PaymentMethod {
                ...
                /// Your crypto will be swapped into GRAM at the current exchange rate.
                public static let cryptoSwapToTonBanner = TKLocales.tr("Localizable", "ramp.deposit.payment_method.crypto_swap_to_ton_banner", fallback: "Your crypto will be swapped into GRAM at the current exchange rate.")
                /// Your stablecoin will be credited as USDT on TON at a 1:1 rate.
                public static let stablecoinCreditUsdtTonBanner = TKLocales.tr("Localizable", "ramp.deposit.payment_method.stablecoin_credit_usdt_ton_banner", fallback: "Your stablecoin will be credited as USDT on TON at a 1:1 rate.")
                /// Your stablecoin will be credited as USDT on TRON at a 1:1 rate.
                public static let stablecoinCreditUsdtTronBanner = TKLocales.tr("Localizable", "ramp.deposit.payment_method.stablecoin_credit_usdt_tron_banner", fallback: "Your stablecoin will be credited as USDT on TRON at a 1:1 rate.")
                /// Payment method
            ...
            public enum PaymentQrCode {
                ...
                public static let subtitle = TKLocales.tr("Localizable", "ramp.deposit.payment_qr_code.subtitle", fallback: "Scan QR code or copy the address to complete the payment.")
                /// Payment QR code
                public static let title = TKLocales.tr("Localizable", "ramp.deposit.payment_qr_code.title", fallback: "Payment QR code")
            }
        }
        ...
        public enum List {
            /// Retry
            public static let loadErrorBannerButton = TKLocales.tr("Localizable", "ramp.list.load_error_banner_button", fallback: "Retry")
            /// Couldn't load more top-up options
            public static let loadErrorBannerTitle = TKLocales.tr("Localizable", "ramp.list.load_error_banner_title", fallback: "Couldn't load more top-up options")
        }
        ...
        public enum PaymentMethod {
            ...
            /// Please choose a different currency.
            public static let noCashMethodsSubtitle = TKLocales.tr("Localizable", "ramp.payment_method.no_cash_methods_subtitle", fallback: "Please choose a different currency.")
            /// No payment methods for this currency
            public static let noCashMethodsTitle = TKLocales.tr("Localizable", "ramp.payment_method.no_cash_methods_title", fallback: "No payment methods for this currency")
        }

        public enum Picker {
            /// ≈ %@ USDT
            public static func approximateUsdtFee(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.picker.approximate_usdt_fee", String(describing: p1), fallback: "≈ %@ USDT")
            }

            /// Asset to withdraw
            public static let assetToWithdrawTitle = TKLocales.tr("Localizable", "ramp.picker.asset_to_withdraw_title", fallback: "Asset to withdraw")
            /// Choose asset
            public static let chooseAssetTitle = TKLocales.tr("Localizable", "ramp.picker.choose_asset_title", fallback: "Choose asset")
            /// Choose currency
            public static let chooseCurrencyTitle = TKLocales.tr("Localizable", "ramp.picker.choose_currency_title", fallback: "Choose currency")
            /// Choose %@ network
            public static func chooseNetworkTitle(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.picker.choose_network_title", String(describing: p1), fallback: "Choose %@ network")
            }

            /// Payment method
            public static let choosePaymentMethodTitle = TKLocales.tr("Localizable", "ramp.picker.choose_payment_method_title", fallback: "Payment method")
            /// Crypto
            public static let cryptoTitle = TKLocales.tr("Localizable", "ramp.picker.crypto_title", fallback: "Crypto")
            /// Withdraw %@ to supported networks anytime via 'Withdraw section'.
            public static func networkFooter(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.picker.network_footer", String(describing: p1), fallback: "Withdraw %@ to supported networks anytime via 'Withdraw section'.")
            }

            /// Ensure you select the right network, or you could risk losing your funds.
            public static let networkWarning = TKLocales.tr("Localizable", "ramp.picker.network_warning", fallback: "Ensure you select the right network, or you could risk losing your funds.")
            public enum Search {
                /// Search
                public static let placeholder = TKLocales.tr("Localizable", "ramp.picker.search.placeholder", fallback: "Search")
                /// Nothing found
                public static let zeroTitle = TKLocales.tr("Localizable", "ramp.picker.search.zero_title", fallback: "Nothing found")
            }
        }
        ...
        public enum ProviderPicker {
            ...
            /// Min. amount: %@ %@
            public static func minAmount(_ p1: Any, _ p2: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.provider_picker.min_amount", String(describing: p1), String(describing: p2), fallback: "Min. amount: %@ %@")
            }
        ...
        public enum Withdraw {
            ...
            /// Choose option to withdraw crypto
            public static let fiatCurrencyBlockHeading = TKLocales.tr("Localizable", "ramp.withdraw.fiat_currency_block_heading", fallback: "Choose option to withdraw crypto")
            /// Methods of sale for
            public static let fiatCurrencyRowCaption = TKLocales.tr("Localizable", "ramp.withdraw.fiat_currency_row_caption", fallback: "Methods of sale for")
            /// Max. amount: %@
            public static func maxAmount(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.withdraw.max_amount", String(describing: p1), fallback: "Max. amount: %@")
            }

            /// Min. amount: %@
            public static func minAmount(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "ramp.withdraw.min_amount", String(describing: p1), fallback: "Min. amount: %@")
            }

            /// Send tokens
            public static let sendTokens = TKLocales.tr("Localizable", "ramp.withdraw.send_tokens", fallback: "Send tokens")
            /// To another TON/TRON wallet
            ...
            public enum PaymentMethod {
                /// Asset to receive
                public static let assetToReceiveTitle = TKLocales.tr("Localizable", "ramp.withdraw.payment_method.asset_to_receive_title", fallback: "Asset to receive")
                /// Receive method
                public static let receiveMethodTitle = TKLocales.tr("Localizable", "ramp.withdraw.payment_method.receive_method_title", fallback: "Receive method")
                /// Sell to Cash
                public static let sellToCash = TKLocales.tr("Localizable", "ramp.withdraw.payment_method.sell_to_cash", fallback: "Sell to Cash")
                /// Withdraw USDT to other stablecoins. A fixed fee applies per network.
                public static let stablecoinWithdrawNetworkFeeBanner = TKLocales.tr("Localizable", "ramp.withdraw.payment_method.stablecoin_withdraw_network_fee_banner", fallback: "Withdraw USDT to other stablecoins. A fixed fee applies per network.")
            }
        }
    }
    ...
    public enum Receive {
        ...
        /// Your address
        public static let yourAddressTitle = TKLocales.tr("Localizable", "receive.your_address_title", fallback: "Your address")
        public enum Multichain {
            ...
            public enum Networks {
                ...
                public enum Solana {
                    /// Solana
                    public static let title = TKLocales.tr("Localizable", "receive.multichain.networks.solana.title", fallback: "Solana")
                }
        ...
        public enum Segments {
            /// TRC20
            public static let trc20 = TKLocales.tr("Localizable", "receive.segments.trc20", fallback: "TRC20")
        }
    ...
    public enum Scanner {
        /// Invalid link
        public static let invalidLink = TKLocales.tr("Localizable", "scanner.invalid_link", fallback: "Invalid link")
        /// Select from Gallery
        public static let selectFromGallery = TKLocales.tr("Localizable", "scanner.select_from_gallery", fallback: "Select from Gallery")
        /// Scan QR code
    ...
    public enum Support {
        public enum SupportPopup {
            /// Ask us via Telegram or Email — we’ll do our best to help.
            public static let caption = TKLocales.tr("Localizable", "support.support_popup.caption", fallback: "Ask us via Telegram or Email — we’ll do our best to help.")
            /// Need help?
            public static let title = TKLocales.tr("Localizable", "support.support_popup.title", fallback: "Need help?")
            public enum Buttons {
                /// Ask on Telegram
                public static let ask = TKLocales.tr("Localizable", "support.support_popup.buttons.ask", fallback: "Ask on Telegram")
                /// Close
                public static let close = TKLocales.tr("Localizable", "support.support_popup.buttons.close", fallback: "Close")
                /// Contact by email
                public static let email = TKLocales.tr("Localizable", "support.support_popup.buttons.email", fallback: "Contact by email")
            }
        }
    }
    ...
    public enum Tabs {
        ...
        /// Trade
        public static let trade = TKLocales.tr("Localizable", "tabs.trade", fallback: "Trade")
        /// Wallet
        public static let wallet = TKLocales.tr("Localizable", "tabs.wallet", fallback: "Wallet")
        public enum History {
            /// History is here now
            public static let hint = TKLocales.tr("Localizable", "tabs.history.hint", fallback: "History is here now")
        }

        public enum Trade {
            /// Trade US Stocks & ETFs
            public static let hint = TKLocales.tr("Localizable", "tabs.trade.hint", fallback: "Trade US Stocks & ETFs")
        }
    }
    ...
    public enum TokenManagement {
        /// Save Changes
        public static let saveChanges = TKLocales.tr("Localizable", "token_management.save_changes", fallback: "Save Changes")
        /// Manage crypto
        public static let title = TKLocales.tr("Localizable", "token_management.title", fallback: "Manage crypto")
    }

    public enum TokensPicker {
        /// mcap
        public static let marketCapSuffix = TKLocales.tr("Localizable", "tokens_picker.market_cap_suffix", fallback: "mcap")
        /// Crypto
        public static let title = TKLocales.tr("Localizable", "tokens_picker.title", fallback: "Crypto")
        public enum Placeholder {
            /// We couldn't load content.
            public static let errorSubtitle = TKLocales.tr("Localizable", "tokens_picker.placeholder.error_subtitle", fallback: "We couldn't load content.")
            /// Something went wrong
            public static let errorTitle = TKLocales.tr("Localizable", "tokens_picker.placeholder.error_title", fallback: "Something went wrong")
            /// There were no results for '%@'.
            public static func noResultsSubtitle(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "tokens_picker.placeholder.no_results_subtitle", String(describing: p1), fallback: "There were no results for '%@'.")
            }

            /// Not Found
            public static let notFoundTitle = TKLocales.tr("Localizable", "tokens_picker.placeholder.not_found_title", fallback: "Not Found")
        }
    ...
    public enum Trade {
        public enum AssetDetails {
            ...
            /// %@ APY
            public static func apyValue(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "trade.asset_details.apy_value", String(describing: p1), fallback: "%@ APY")
            }
            ...
            public enum Balance {
                /// Your balance
                public static let title = TKLocales.tr("Localizable", "trade.asset_details.balance.title", fallback: "Your balance")
            }

            public enum Common {
                /// N/A
                public static let notAvailable = TKLocales.tr("Localizable", "trade.asset_details.common.not_available", fallback: "N/A")
                /// See All
                public static let seeAll = TKLocales.tr("Localizable", "trade.asset_details.common.see_all", fallback: "See All")
            }

            public enum Errors {
                /// Unable to load asset details.
                public static let load = TKLocales.tr("Localizable", "trade.asset_details.errors.load", fallback: "Unable to load asset details.")
            }

            public enum History {
                /// Transaction history
                public static let title = TKLocales.tr("Localizable", "trade.asset_details.history.title", fallback: "Transaction history")
            }

            public enum Overview {
                /// Circulating Supply
                public static let circulatingSupply = TKLocales.tr("Localizable", "trade.asset_details.overview.circulating_supply", fallback: "Circulating Supply")
                /// Tokens currently available in the market and held by users.
                public static let circulatingSupplyHint = TKLocales.tr("Localizable", "trade.asset_details.overview.circulating_supply_hint", fallback: "Tokens currently available in the market and held by users.")
                /// Market Cap
                public static let marketCap = TKLocales.tr("Localizable", "trade.asset_details.overview.market_cap", fallback: "Market Cap")
                /// Total value of all existing tokens at current price.
                public static let marketCapHint = TKLocales.tr("Localizable", "trade.asset_details.overview.market_cap_hint", fallback: "Total value of all existing tokens at current price.")
                /// Total Supply
                public static let totalSupply = TKLocales.tr("Localizable", "trade.asset_details.overview.total_supply", fallback: "Total Supply")
                /// All tokens that exist, including locked and unreleased.
                public static let totalSupplyHint = TKLocales.tr("Localizable", "trade.asset_details.overview.total_supply_hint", fallback: "All tokens that exist, including locked and unreleased.")
            }

            public enum Placeholder {
                /// Back
                public static let back = TKLocales.tr("Localizable", "trade.asset_details.placeholder.back", fallback: "Back")
            }

            public enum Sections {
                /// About
                public static let about = TKLocales.tr("Localizable", "trade.asset_details.sections.about", fallback: "About")
                /// Links
                public static let links = TKLocales.tr("Localizable", "trade.asset_details.sections.links", fallback: "Links")
                /// Overview
                public static let overview = TKLocales.tr("Localizable", "trade.asset_details.sections.overview", fallback: "Overview")
                /// 24h Trading activity
                public static let tradingActivity = TKLocales.tr("Localizable", "trade.asset_details.sections.trading_activity", fallback: "24h Trading activity")
            }

            public enum Tokenized {
                public enum Etf {
                    /// Tokenized ETF
                    public static let badge = TKLocales.tr("Localizable", "trade.asset_details.tokenized.etf.badge", fallback: "Tokenized ETF")
                    /// Tokenized ETFs are blockchain tokens backed 1:1 by real ETF shares, allowing fractional purchases and linking traditional markets with crypto.
                    public static let caption = TKLocales.tr("Localizable", "trade.asset_details.tokenized.etf.caption", fallback: "Tokenized ETFs are blockchain tokens backed 1:1 by real ETF shares, allowing fractional purchases and linking traditional markets with crypto.")
                    /// Buy or sell 24/7, beyond regular market hours.
                ...
                public enum Stock {
                    /// Tokenized Stock
                    public static let badge = TKLocales.tr("Localizable", "trade.asset_details.tokenized.stock.badge", fallback: "Tokenized Stock")
                    /// Tokenized stocks are blockchain tokens backed 1:1 by real shares, allowing fractional purchases and linking traditional markets with crypto.
                    public static let caption = TKLocales.tr("Localizable", "trade.asset_details.tokenized.stock.caption", fallback: "Tokenized stocks are blockchain tokens backed 1:1 by real shares, allowing fractional purchases and linking traditional markets with crypto.")
                    /// Buy or sell 24/7, beyond regular market hours.
            ...
            public enum TradingActivity {
                ...
                /// Volume
                public static let volumeTitle = TKLocales.tr("Localizable", "trade.asset_details.trading_activity.volume_title", fallback: "Volume")
            }
        }
        ...
        public enum Assets {
            ...
            public enum Errors {
                ...
                public static let load = TKLocales.tr("Localizable", "trade.assets.errors.load", fallback: "Unable to load assets.")
            }

            public enum Placeholder {
                /// No assets found.
                public static let empty = TKLocales.tr("Localizable", "trade.assets.placeholder.empty", fallback: "No assets found.")
            }
        }
        ...
        public enum Placeholder {
            /// No market shelves available.
            public static let empty = TKLocales.tr("Localizable", "trade.placeholder.empty", fallback: "No market shelves available.")
            /// We couldn't load content.
            public static let errorSubtitle = TKLocales.tr("Localizable", "trade.placeholder.error_subtitle", fallback: "We couldn't load content.")
            /// Something went wrong
            public static let errorTitle = TKLocales.tr("Localizable", "trade.placeholder.error_title", fallback: "Something went wrong")
            /// There were no results for '%@'.
            public static func noResultsForQuery(_ p1: Any) -> String {
                return TKLocales.tr("Localizable", "trade.placeholder.no_results_for_query", String(describing: p1), fallback: "There were no results for '%@'.")
            }

            /// Not Found
            public static let notFoundTitle = TKLocales.tr("Localizable", "trade.placeholder.not_found_title", fallback: "Not Found")
        }
    ...
    public enum TronUsdtFees {
        public enum Common {
            ...
            public enum ItemTitle {
                ...
                /// GRAM
                public static let ton = TKLocales.tr("Localizable", "tron_usdt_fees.common.item_title.ton", fallback: "GRAM")
                /// TRX
        ...
        public enum TokenDetails {
            ...
            public enum Banners {
                public enum FeeOptionsInsufficient {
                    /// Top up Battery, GRAM or TRX balance to cover transaction fees.
                    public static let caption = TKLocales.tr("Localizable", "tron_usdt_fees.token_details.banners.fee_options_insufficient.caption", fallback: "Top up Battery, GRAM or TRX balance to cover transaction fees.")
    ...
    public enum W5Stories {
        public enum Gasless {
            /// Send USDT without having GRAM – transaction fees will be covered by a few cents of USDT automatically.
            public static let subtitle = TKLocales.tr("Localizable", "w5_stories.gasless.subtitle", fallback: "Send USDT without having GRAM – transaction fees will be covered by a few cents of USDT automatically.")
    ...
    public enum WalletButtons {
        /// Buy GRAM
        public static let buy = TKLocales.tr("Localizable", "wallet_buttons.buy", fallback: "Buy GRAM")
        /// Add Funds
        public static let deposit = TKLocales.tr("Localizable", "wallet_buttons.deposit", fallback: "Add Funds")
        /// Receive
