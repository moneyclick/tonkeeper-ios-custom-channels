...
class DappWalletKitViewModel: DappViewModelImplementation {
    ...
    deinit {
        do {
            ...
            Log.e(
                "\(String(reflecting: Self.self)): failed to remove events handler on deinit",
                extraInfo: [
    ...
    init(
        ...
        do {
            ...
            Log.e(
                "\(String(reflecting: Self.self)): failed to add events handler",
                extraInfo: [
                    "error": error.localizedDescription,
                ]
            )
        ...
        self.webViewCustomizationHandler = { [weak self] webView in
            ...
            do {
                ...
                Log.e(
                    "\(String(reflecting: Self.self)): failed to inject TONWalletKit bridge into web view",
                    extraInfo: [
                        "error": error.localizedDescription,
                    ]
                )
