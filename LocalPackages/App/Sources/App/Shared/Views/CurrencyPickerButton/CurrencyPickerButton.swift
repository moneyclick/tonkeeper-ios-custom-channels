...
final class CurrencyPickerButton: UIControl {
    ...
    struct Configuration {
        ...
        let image: TKImage?
        let currencyCodeTextStyle: TKTextStyle

        init(currencyCode: String?, image: TKImage?, currencyCodeTextStyle: TKTextStyle = .body2) {
            self.currencyCode = currencyCode
            self.image = image
            self.currencyCodeTextStyle = currencyCodeTextStyle
        }
    }
    ...
    private func didUpdateConfiguration() {
        ...
        codeLabel.font = configuration.currencyCodeTextStyle.font
