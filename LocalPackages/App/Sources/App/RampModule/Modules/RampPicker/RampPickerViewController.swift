...
final class RampPickerViewController: GenericViewViewController<RampPickerView> {
    ...
    private var shouldFocusSearchOnAppear = false
    private var didApplyInitialSearchFocus = false
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        guard shouldFocusSearchOnAppear, !didApplyInitialSearchFocus else { return }
...
private extension RampPickerViewController {
    ...
    func setupBindings() {
        ...
        viewModel.didUpdateLayoutConfiguration = { [weak self] config in
            ...
            shouldFocusSearchOnAppear = config.shouldFocusSearchOnAppear
