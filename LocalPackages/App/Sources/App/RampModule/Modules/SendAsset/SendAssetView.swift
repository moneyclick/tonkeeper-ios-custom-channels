...
final class SendAssetView: TKView {
    ...
    let addressPlainView = SendAssetAddressPlainView()
    let addressMemoView = SendAssetAddressMemoView()
    ...
    override func setup() {
        ...
        goToMainButtonContainer.backgroundView = TKGradientView(
        ...
        addressDetailsStack.addArrangedSubview(addressPlainView)
        addressDetailsStack.addArrangedSubview(addressMemoView)
        ...
        contentStackView.setCustomSpacing(24, after: exchangeView)
