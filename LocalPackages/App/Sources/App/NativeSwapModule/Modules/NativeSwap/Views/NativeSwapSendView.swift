...
final class NativeSwapSendView: UIControl {
    ...
    func update(
        ...
        case .insufficient:
            insufficientLabel.attributedText = TKLocales.InsufficientFunds.title.withTextStyle(
                .body2,
                color: .Accent.red,
                alignment: .right,
                lineBreakMode: .byTruncatingTail
    ...
    private func setup() {
        ...
        insufficientLabel.setContentHuggingPriority(.defaultLow, for: .horizontal)
        insufficientLabel.isUserInteractionEnabled = false
    ...
    private func setupConstraints() {
        ...
        accessoryStack.addArrangedSubview(insufficientLabel)
