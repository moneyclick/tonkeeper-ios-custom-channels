...
extension AccountEventAction.WithdrawStakeRequest {
    init(withdrawStakeRequest: TonAPI.WithdrawStakeRequestAction) throws {
        ...
        if let meta = withdrawStakeRequest.stakeMeta {
            self.stakeMeta = AccountEventAction.TokenAmount(
                value: meta.value,
                tokenName: meta.tokenName,
                currencyType: meta.currencyType.rawValue,
                decimals: meta.decimals,
                verification: meta.verification.rawValue,
                image: meta.image,
                jetton: meta.jetton
            )
        } else {
