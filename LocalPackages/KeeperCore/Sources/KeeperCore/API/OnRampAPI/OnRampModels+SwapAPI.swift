...
extension OnRampLayoutItem {
    init?(api: SwapAPI.Components.Schemas.ExchangeLayoutItem) {
        guard let type = OnRampLayoutItemType(rawValue: api._type.rawValue) else { return nil }
