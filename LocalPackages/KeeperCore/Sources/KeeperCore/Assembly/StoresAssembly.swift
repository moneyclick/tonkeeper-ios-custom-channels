...
public final class StoresAssembly {
    ...
    private weak var _homeBannersStore: HomeBannersStore?
    public var homeBannersStore: HomeBannersStore {
        if let store = _homeBannersStore {
            return store
        } else {
            let store = HomeBannersStore(
                repository: repositoriesAssembly.homeBannersRepository()
            )
            _homeBannersStore = store
            return store
        }
    }
