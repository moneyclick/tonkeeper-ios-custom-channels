...
public enum OnRampLayoutItemType: String, Codable, Equatable, Hashable, Sendable {
    case fiat
    case crypto
    case stablecoin
}

public struct OnRampLayoutItem: Codable, Equatable, Hashable {
    public let type: OnRampLayoutItemType
    public let title: String
...
public struct OnRampLayout: Codable, Equatable {
    public let items: [OnRampLayoutItem]
