...
struct LightColorScheme: ColorScheme {
    var backgroundContentAlternate: UIColor {
    ...
    var backgroundPageAlternate: UIColor {
        return UIColor(hex: "#FFFFFF")
    }
    ...
    var tabBarActiveIconLiquidGlass: UIColor {
        return UIColor(hex: "#006EF7")
    }
