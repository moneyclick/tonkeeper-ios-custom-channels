...
public extension UIColor {
    enum Background {
        ...
        public static let pageAlternate = UIColor {
            TKThemeManager.shared.themeAppearance.colorScheme(for: $0.userInterfaceStyle).backgroundPageAlternate
        }
    ...
    enum TabBar {
        ...
        public static let activeIconLiquidGlass = UIColor {
            TKThemeManager.shared.themeAppearance.colorScheme(for: $0.userInterfaceStyle).tabBarActiveIconLiquidGlass
        }
