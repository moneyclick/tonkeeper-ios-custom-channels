...
public final class TKSlider: UIView {
    ...
    public var swipeHandleAccessibilityIdentifier: String? {
        didSet {
            dragView.accessibilityIdentifier = swipeHandleAccessibilityIdentifier
            dragView.isAccessibilityElement = swipeHandleAccessibilityIdentifier != nil
        }
    }
